  ...
  def __init__(self,
    ...
    with tf.variable_scope(scope, default_name="models"):
      with tf.variable_scope("embeddings"):
        ...
        # # Add sentence_ids and tts_dist embedding, then layer normalize and preform dropout
        # self.embedding_output = embedding_sentence_dist(self.embedding_output,
        #                                                 sentence_ids=sentence_ids,
        #                                                 max_sentence_len=config.max_sentence_len,
        #                                                 tts_dist=tts_dist,
        #                                                 dist_bucket_boundaries=config.dist_bucket_boundaries,
        #                                                 initializer_range=config.initializer_range,
